...
public abstract class BaseObserver<T> implements Observer<BaseResult<T>>,
    ...
    public BaseObserver(@NonNull BaseMvpView view, Boolean... isShowErrorView) {
        this(isShowErrorView);
        this.mView = view;
    }

    public <R extends BaseMvpView> BaseObserver(@NonNull RxPresenter<R> presenter, Boolean...
            isShowErrorView) {
        this(isShowErrorView);
    ...
    public BaseObserver(Boolean... isShowErrorView) {
...
//        }
    ...
    public void onSubscribe(Disposable d) {
        if (checkedNet()) {
            ...
            LogUtils.i("tjtmain -observer", Thread.currentThread().getName());
