...
//            String string64 = new String(Base64Utils.encode(baos.toByteArray(), Base64Utils.DEFAULT));
...
//                return null;
//            }
//            byte[] base64Bytes = Base64Utils.decode(base64.getBytes(), Base64Utils.DEFAULT);
