package com.base.baselibrary.util.cityUtil.adapter;
...
import com.base.baselibrary.util.cityUtil.widget.ContactItemInterface;
import com.base.baselibrary.util.cityUtil.widget.ContactListAdapter;
...
public class CityAdapter extends ContactListAdapter {
    ...
    public void populateDataForRow(View parentView, ContactItemInterface item,
        ...
        TextView nicknameView = infoView
