...
// Need to use getContext() here so that we use the themed context
    ...
    public void setMyCenterIcon(Drawable drawable) {
        ...
        if (this.mCenterIcon == null) {
            ...
            ViewGroup.LayoutParams layoutParams =new ViewGroup.LayoutParams(ScreenUtils.dip2px
                    (68),ScreenUtils.dip2px(24));
            mCenterIcon.setLayoutParams(layoutParams);
